...
class BuildCommand extends base_1.CordovaCommand {
    async getMetadata() {
        ...
        return {
            ...
            description: `
Like running ${color_1.input('cordova build')} directly, ${color_1.input('ionic cordova build')} also builds web assets from ${color_1.input('ionic build')} and provides friendly checks for Android and iOS platforms.
