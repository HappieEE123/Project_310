...
class DocsCommand extends command_1.Command {
    ...
    async run(inputs, options) {
        ...
        this.env.log.warn(`The ${color_1.input('ionic docs')} command has been deprecated and will be removed in an upcoming major release of the Ionic CLI. Developers should bookmark ${url} in their browser for easy access.`);
        try {
