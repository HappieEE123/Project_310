...
class DoctorCommand extends command_1.Command {
    ...
    async detectAilments() {
        ...
        this.env.log.warn(`The ${color_1.input('ionic doctor')} command has been deprecated and will be removed in an upcoming major release of the Ionic CLI. Developers can safely remove any references to this command as many of the checks are no longer needed.`);
        if (!isLoggedIn) {
