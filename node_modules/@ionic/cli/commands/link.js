...
If the ${color_1.input('id')} argument is excluded, this command will prompt you to select an app from Appflow.

Appflow uses a git-based workflow to manage app updates. During the linking process, select ${color_1.strong('GitHub')} (recommended) or ${color_1.strong('Appflow')} as a git host. See our documentation[^appflow-git-basics] for more information.
...
If you are having issues linking, please get in touch with our Support[^support-request].
      `,
            ...
            inputs: [
                {
                    name: 'id',
                    summary: `The Appflow ID of the app to link (e.g. ${color_1.input('a1b2c3d4')})`,
                },
            ],
            options: [
                {
