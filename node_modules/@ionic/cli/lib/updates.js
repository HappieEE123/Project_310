...
exports.IONIC_CLOUD_CLI_MIGRATION = (() => `${color_1.strong(color_1.WARN('Deprecated: Ionic Appflow functionality has moved to the new Ionic Cloud CLI'))}.\n` +
    `Existing functionality in the Ionic CLI is deprecated as of ${color_1.WARN('v6.18.0')}. ` +
    ...
    `${color_1.strong('https://ionic.io/docs/appflow/cli/migration/')}\n`)();
