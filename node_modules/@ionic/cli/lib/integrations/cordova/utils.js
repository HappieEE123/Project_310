...
async function confirmCordovaBrowserUsage({ log, prompt }) {
    ...
    log.warn(`About to add the ${color_1.input('browser')} platform to your app.\n` +
        ...
        `Alternatively, ${emoji_1.emoji('⚡️ ', '')}${color_1.strong('Capacitor')}${emoji_1.emoji(' ⚡️', '')} (${color_1.strong('https://ion.link/capacitor')}), Ionic's official native runtime, fully supports traditional web and Progressive Web Apps. See the Capacitor docs${color_1.ancillary('[2]')} to learn how easy it is to migrate.\n\n` +
